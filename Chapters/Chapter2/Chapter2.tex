...
We know from (* REF CH1 *) that an arbitrary vector, $V$ in the space described by $A$ can be spectrally decomposed into a weighted sum of eigenvectors, $\{e_{i}\}$ of $A$; $v = \sum_{i}{c_{i}e_{i}} for \{c_{i}\} \in \C$.
